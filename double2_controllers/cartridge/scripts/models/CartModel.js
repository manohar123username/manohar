...
var CartModel = AbstractModel.extend({
    ...
    addBonusProduct: function (bonusDiscountLineItem, product, selectedOptions, quantity) {
        ...
        var UpdateProductOptionSelections = require('double2_core/cartridge/scripts/cart/UpdateProductOptionSelections');
    ...
    validateForCheckout: function () {
        var ValidateCartForCheckout = require('double2_core/cartridge/scripts/cart/ValidateCartForCheckout');
...
CartModel.goc = function () {
    ...
    var basket = BasketMgr.getCurrentOrNewBasket();// returns current valid basket of the session customer or creates a new one if no current valid basket exists.
